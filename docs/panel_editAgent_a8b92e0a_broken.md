...
intent           : undefined
startTime        : 2025-07-10T23:45:58.303Z
endTime          : 2025-07-10T23:46:02.454Z
duration         : 4151ms
ourRequestId     : efa1dcf3-836d-4801-8a7d-36023b3c583f
requestId        : efa1dcf3-836d-4801-8a7d-36023b3c583f
serverRequestId  : efa1dcf3-836d-4801-8a7d-36023b3c583f
timeToFirstToken : 2546ms
usage            : {"completion_tokens":135,"prompt_tokens":11175,"prompt_tokens_details":{"cached_tokens":8904},"total_tokens":11310}
tools           : [
    {
        "function": {
...
~~~md
<attachments>
<attachment id="prompt:trivy-code-scan-broken.prompt.md" filePath="/workspaces/copilot-mcp-tools-issue/.github/prompts/trivy-code-scan-broken.prompt.md">
...
### Assistant
````md
I'll help you perform a comprehensive vulnerability scan using Trivy on your codebase. Based on the instructions in the prompt file, I need to ask for the codebase to scan first, then use the trivy-mcp tool to perform the vulnerability scan.

Let me start by examining the current workspace structure to understand what we're working with: 
🛠️ semantic_search (toolu_vrtx_01HYT2jfvd4HKMuUPic1qyDL) {
  "query": "vulnerability scan security issues codebase dependencies"
}
````
